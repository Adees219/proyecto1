...
# 1 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\xc.inc" 1 3
...
# 1 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\pic.inc" 1 3



# 1 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\pic_as_chip_select.inc" 1 3
# 724 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\proc\\pic16f887.inc" 1 3
# 48 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\proc\\pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2819 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\proc\\pic16f887.inc" 3
...
# 725 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\pic_as_chip_select.inc" 2 3
# 5 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\pic.inc" 2 3
...
auto_size SET 0
ENDM
# 8 "E:/MPlab/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\xc.inc" 2 3
# 14 "generador.s" 2
...
;------------------------------------------macros-------------------------------------------
 reinicio_tmr0 macro
    ...
    movwf TMR0
    bcf ((INTCON) and 07Fh), 2 ;termina con la interrupcion
endm
...
isr: ; rutina de interrupcion
   ...
   btfsc ((INTCON) and 07Fh), 2 ;comprueba la bandera de tmr0
...
loop:
    ...
    btfss PORTB, 0 ;verifica si el ((PORTB) and 07Fh), 0 devuelve 0 (presionado)
    call change_mode ;subrutina que cambia la onda a mostrar (cuadrada-triangular)

    btfss PORTB, 1 ;verifica si el ((PORTB) and 07Fh), 1 devuelve 0 (presionado)
    call incr_freq ;subrutina que incrementa la variable ctrlFR (controlador FRecuencia)

    btfss PORTB, 2 ;verifica si el ((PORTB) and 07Fh), 2 devuelve 0 (presionado)
...
triangular:
 ...
 t_inc:
    ...
    btfss STATUS, 2 ;si el bit ((STATUS) and 07Fh), 2 se enciende indica que el puerto ha llegado a su valor máximo, por lo que tiene que cambiar la pendiente
    goto $+3 ; si no se enciende el bit ((STATUS) and 07Fh), 2, retorna
...
t_dec:
    ...
    btfss STATUS, 2 ;testeo si la variable ya llego a cero, si el bit ((STATUS) and 07Fh), 2 se enciende, indica que llego a su valor minimo, toca cambiar la pendiente
    goto $+5 ; si no se enciende el bit ((STATUS) and 07Fh), 2, retorna
...
;--------------------------------------------subrutinas setup---------------------------------------
 config_io:
    ...
    bsf ((WPUB) and 07Fh), 0 ;pull-ups internos 1: enabled
    bsf ((WPUB) and 07Fh), 1
 ...
 config_tmr0:
    banksel OPTION_REG
    bcf ((OPTION_REG) and 07Fh), 5 ;mode: temporizador
    bcf ((OPTION_REG) and 07Fh), 3 ;prescaler para temporizador
    return
...
config_int_enable:
    bsf ((INTCON) and 07Fh), 7 ;global interrupt enable
    bsf ((INTCON) and 07Fh), 5 ; tmr0 interrupt enable
    bcf ((INTCON) and 07Fh), 2 ; bandera interrupcion
    return
